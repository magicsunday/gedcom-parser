 ...
 * `EVENT_DETAIL` substructures (the contact block, `AGNC`, `RELI`, associations, `OBJE`) remain a
 * follow-up.
 *
...
class EventAttributeDetailExtrasTest extends TestCase
{
     ...
     * child (a responsible agency, deferred) stays on the event's own `$unknown`.
     */
    #[Test]
    public function typesTheEventDescriptorSubstructures(): void
    {
        ...
        self::assertSame(['AGNC'], $this->tags($event->unknown));
    }
